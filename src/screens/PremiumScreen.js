    ...
    <ScrollView contentContainerStyle={styles.container}>
            ...
            >
              <View>
                <Text style={[styles.planName, isSelected && styles.selectedText]}>
                  {pack.product.title} {/* e.g. "Monthly" */}
                </Text>
      ...
      <TouchableOpacity style={styles.subscribeButton} onPress={handleSubscribe}>
        <Text style={styles.subscribeText}>
          {selectedPackage?.packageType === 'LIFETIME' ? "Unlock Forever" : "Start 7-Day Free Trial"}
        </Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  planCard: { 
    ...
    padding: 20, marginBottom: 10, borderRadius: 12, borderWidth: 1, borderColor: '#ddd', backgroundColor: '#f9f9f9' 
  },
